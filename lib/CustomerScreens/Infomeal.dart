              ...
              child: Column(
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        "Meals ingredients : ",
                        style: TextStyle(
                            fontWeight: FontWeight.normal, fontSize: 20, fontFamily: "Montserrat"),
                      ),
                  ...
                  Column(
                    ...
                    children: [
                      Text("Sauce Gruyére", style: TextStyle(fontFamily: "Montserrat",fontSize: 20,fontWeight: FontWeight.bold),),
                      SizedBox(height: 20,),
                      Text("Viande Hachée ",style: TextStyle(fontFamily: "Montserrat",fontSize: 20,fontWeight: FontWeight.bold),),
                      SizedBox(height: 20,),
                      Text("Olive",style: TextStyle(fontFamily: "Montserrat",fontSize: 20,fontWeight: FontWeight.bold),),
                      SizedBox(height: 20,),
                      Container(
